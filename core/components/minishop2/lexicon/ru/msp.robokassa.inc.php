...
$_lang['setting_ms2_payment_rbks_fiskal'] = 'Фискализация Robokassa';
$_lang['setting_ms2_payment_rbks_fiskal_desc'] = 'Если включено, будет передавать список товаров в Robokassa для фискализации';
